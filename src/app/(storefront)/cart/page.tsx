  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      <div className="mb-8">
        ...
        {items.length > 0 && (
          <p className="text-sm text-[#555577] mt-1">{items.length} item{items.length !== 1 ? "s" : ""}</p>
        )}
      </div>
      ...
      {items.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-24 text-center">
          ...
          <p className="text-sm text-[#555577] mb-6">Browse our catalog and add some anime merch to get started.</p>
          <Button asChild>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="flex flex-col flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      ...
                      <p className="text-xs text-[#555577] mt-0.5">{item.variantLabel}</p>
                    </div>
                    <button
                      onClick={() => removeItem(item.variantId)}
                      className="text-[#555577] hover:text-[#ef4444] transition-colors shrink-0"
                    >
                  ...
                  <div className="flex items-center justify-between mt-3">
                    <div className="flex items-center border border-[#2a2a3d] rounded-sm">
                      <button
                        ...
                        className="flex items-center justify-center w-8 h-8 text-[#8888aa] hover:text-[#f0f0ff] hover:bg-[#1a1a27] transition-all"
                      >
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-20 rounded-sm border border-[#2a2a3d] bg-[#12121a] p-6 space-y-4">
              <h2 className="text-base font-black text-[#f0f0ff]" style={{ fontFamily: "var(--font-syne)" }}>
                Order Summary
              </h2>
              ...
              <div>
                ...
                <p className="text-[10px] text-[#555577] mt-1">Try: AKIBA10, FREESHIP, SAVE20</p>
              </div>
              ...
              <div className="border-t border-[#2a2a3d] pt-4 space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className={shipping === 0 ? "text-[#10b981] font-semibold" : "text-[#f0f0ff] font-semibold"}>
              ...
              <div className="border-t border-[#2a2a3d] pt-4 flex justify-between">
                <span className="font-black text-[#f0f0ff]" style={{ fontFamily: "var(--font-syne)" }}>Total</span>
                <span className="font-black text-xl text-[#f0f0ff]" style={{ fontFamily: "var(--font-syne)" }}>
                  {formatPrice(total)}
                </span>
              </div>
