...
type Product = { id: string; name: string; description: string; brand: string | null; isActive: boolean; isPreOrder: boolean; variants: Variant[]; categories: { category: { id: string; name: string } }[] }
...
export function ProductEditForm({ product, categories }: { product: Product; categories: Category[] }) {
  ...
  async function saveProduct(e: React.FormEvent) {
    ...
    if (res.ok) { setSuccess("Product updated!"); router.refresh() }
  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      <form onSubmit={saveProduct} className="rounded-sm border border-[#2a2a3d] bg-[#12121a] p-6 space-y-4">
